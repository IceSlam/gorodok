<?php
/**
 * The ultimate single page template
 *
...
<?php
    ...
    if ($queried_post_type == 'catalog') { ?>
        ...
        <section id="is-catlist" class="section is-catlist container" style="padding-bottom: 0;">
            <div class="row is-catlist__catbtns" style="margin-bottom: 0;">
                <div class="col-sm-6 col-md-4 col-lg-2 mt-3">
                    <div class="is-catlist__catbtns-card">
                        ...
                        <a class="is-catlist__catbtns-card__title" href="<? echo get_term_link(51, 'services'); ?>" target="_blank">
                ...
                <div class="col-sm-6 col-md-4 col-lg-2 mt-3">
                    <div class="is-catlist__catbtns-card">
                        ...
                        <a class="is-catlist__catbtns-card__title" href="<? echo get_term_link(52, 'services'); ?>" target="_blank">
                ...
                <div class="col-sm-6 col-md-4 col-lg-2 mt-3">
                    <div class="is-catlist__catbtns-card">
                        ...
                        <a class="is-catlist__catbtns-card__title" href="<? echo get_term_link(53, 'services'); ?>" target="_blank">
                            Полиграфия
                        </a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-2 mt-3">
                    <div class="is-catlist__catbtns-card">
                        ...
                        <a class="is-catlist__catbtns-card__title" href="<? echo get_term_link(54, 'services'); ?>" target="_blank">
                            Led-технологии
                        </a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-2 mt-3">
                    <div class="is-catlist__catbtns-card">
                        ...
                        <a class="is-catlist__catbtns-card__title" href="<? echo get_term_link(55, 'services'); ?>" target="_blank">
                ...
                <div class="col-sm-6 col-md-4 col-lg-2 mt-3">
                    <div class="is-catlist__catbtns-card">
                        ...
                        <a class="is-catlist__catbtns-card__title" href="<? echo get_term_link(56, 'services'); ?>" target="_blank">
                            УФ-печать
                        </a>
                    </div>
                </div>
        ...
        <section id="-is-category-title" class="section is-category-title">
            <div class="container">
                <div class="row">
                    <div class="col-lg-9">
                        <h2 class="is-category-title__title" style="text-align: left;margin: 0;">
                            <?
                            $terms = get_the_terms(get_the_ID(), 'services');
                            $term_desc = $terms[0]->description;
                            echo $term_desc;
                            ?>
                        </h2>
                    </div>
                    <div class="col-lg-3 d-flex align-items-center justify-content-center">
                        <div class="dropdown is-category-title__dropdown">
                            <a
                                class="is-category-title__dropdown-btn dropdown-toggle"
                                href="#"
                                role="button"
                                id="dropdownMenuLink"
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <?
                                $terms_array = get_the_terms(get_the_ID(), 'services');
                                $term_slug = $terms_array[0]->slug;
                                $args = array(
                                    'post_type'      => 'catalog',
                                    'post_status'    => 'publish',
                                    'posts_per_page' => - 1,
                                ...
                                if ( $query->have_posts() ) {
                                    while ( $query->have_posts() ) {
                                        $query->the_post(); ?>
                                        <li><a class="dropdown-item" href="<? the_permalink(); ?>"><? the_title(); ?></a></li>
                                    <?  }
                                } else {
        ...
        <section id="is-category-products" class="section is-category-products">
            <div class="container">
                <div class="row is-category-products__card">
                    <div class="col-lg-12">
                        <div class="row is-category-products__card-wrapper">
                            <div class="col-lg-4 is-category-products__card-wrapper__img">
                                <div class="is-category-products__card-wrapper__img-inner" style="background: url('<? the_post_thumbnail_url(); ?>');"></div>
                            </div>
                            <div class="col-lg-8 is-category-products__card-wrapper__info">
                                <div class="is-category-products__card-wrapper__info-content">
                                    <h5 class="is-category-products__card-wrapper__info-content__title">
                                        <? the_title(); ?>
                                    </h5>
                                    <div class="is-category-products__card-wrapper__info-content__content">
                                        <? the_content(); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row is-category-products__card-portfolio">
                            <div class="col-lg-12">
                                <div class="row">
                                    <h4 class="is-category-products__card-portfolio__title">
                                        Портфолио работ
                                    </h4>
                                </div>
                                ...
                                <div class="row mt-5">
                                    <div class="col-lg-12 d-flex justify-content-center">
                                        <a href="/catalog" class="is-category-products__card-bbtn">
                                            В каталог
                                        </a>
                                        <a href="!#" class="is-category-products__card-btn">
                                            Заказать услугу
                                        </a>
                                    </div>
                                </div>
    ...
    <? }
    elseif ($queried_post_type == 'portfolio') { ?>
        <section id="is-theader" class="section is-theader container" style="padding-bottom: 1rem;">
            <div class="row">
                <div class="col-lg-12">
